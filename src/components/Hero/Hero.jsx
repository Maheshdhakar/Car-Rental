    ...
    <div className="dark:bg-black dark:text-white duration-300 ">
      <div className="container min-h-[620px] flex">
        <div className="grid place-items-center grid-cols-1 sm:grid-cols-2">
          ...
          data-aos-duration="1500" className="order-1 sm:order-2">
            <img
          ...
          <div className="order-2 sm:order-1 space-y-5 sm:pr-32">
            ...
            <h1 
            data-aos="fade-up"
            data-aos-delay="600"className="text-5xl lg:text-7xl font-semibold font-serif">
              Car Rental
            </h1>
            <p
            data-aos="fade-up"
             data-aos-delay="1000">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quas nesciunt beatae recusandae pariatur. Ea.
            </p>
